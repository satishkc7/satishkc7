...
**AI & Automation Consultant | Data Scientist | ML Engineer**
...
I architect production AI systems that turn complex data problems into measurable business outcomes - spanning ML pipelines, LLM-powered automation, and end-to-end system design.

**Currently** at **Bridgital** - building distributed automation systems, generative AI agents with compliance guardrails, and semantic search pipelines on AWS Bedrock.
...
- **AWS Certified AI Practitioner** - Amazon Web Services ([Verify](https://www.credly.com/badges/a3a355b1-1327-47bd-9158-6454cc78b0b5/linked_in_profile))
- **MLOps: Getting Started** - Google Cloud
- **Transformer Models and BERT** - Google Cloud
- **Encoder-Decoder Architecture** - Google Cloud
- **AI Demystified** - IBM WatsonX
